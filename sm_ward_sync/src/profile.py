...
class Profile(Document):
    ...
    geo_coordinates = ListField()
    geo_location = StringField(max_length=255)
    locations = ListField()
    organization = StringField(null=True)
    social_handles = DictField()
    role_ids = ListField()
    role_names = ListField()
    ulb = DictField()
    engineer = DictField()
    events_count = IntField()
    statistics = DictField()
    state_admin = DictField()
    mohua = DictField()
    posts_count = IntField()
    migrated_source = StringField()
